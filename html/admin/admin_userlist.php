                ...
                ?>
                    <tr class=>
                        ...
                        <td data-label="Username"><?php echo $row["Username"]; ?></td>
                                ...
                                <td data-label="Email Address" class="toggle-content"><span><?php echo $row["EmailAddress"]; ?></span></td>
                                <td data-label="Contact Number" class="toggle-content"><span><?php echo $row["ContactNumber"]; ?></span></td>
                                <td data-label="First Name" class="toggle-content"><span><?php echo $row["firstname"]; ?></span></td>
                                <td data-label="Last Name" class="toggle-content"><span><?php echo $row["lastname"]; ?></span></td>
                                <td data-label="Account Creation" class="toggle-content"><span><?php echo $row["account_creation"]; ?></span></td>
