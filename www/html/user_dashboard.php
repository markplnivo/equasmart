...
<style>
    ...
    *, body{
    ...
    .liveImage video {
        ...
        border-radius: 10px;
        width: 30%; /* Smaller width for the videos */
        height: auto;
    ...
    .liveImage .videoWrapper {
        width: 100%; /* Full width for each video wrapper */
        height: auto; /* Adjust height */
        /* display: block; Ensure block display to stack vertically */
        margin-bottom: 10px; /* Space between stacked videos */
        margin-left: 5%;
    }
        ...
        <div class="liveImage">
            ...
            <div class="videoWrapper">
                <!-- <video id="video1" autoplay controls> -->
                    ...
                    <img id="video1" src="http://esp32feeder.local:81/stream" alt="ESP32 Cam Stream" style="transform: rotate(90deg);width: 40%;margin-top:10%; margin-right:2%;">
                <!-- </video> -->
