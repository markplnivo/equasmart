...
canvas {
    ...
    height: 10%; /* Make sure the canvas takes full height */
     ...
     #input1 {
        background-color: #ffe6e6; /* Solid light red for Ammonia */
    }

    #input2 {
        background-color: #f0e6ff; /* Solid light violet for Nitrate */
    }

    #input3 {
        background-color: #e6f2ff; /* Solid light blue for pH */
    }

    /* Hover effect with distinct colors */
    #input1:hover {
        background-color: #fc9680; /* Darker red on hover for Ammonia */
    }

    #input2:hover {
        background-color: #de9df6; /* Darker violet on hover for Nitrate */
    }

    #input3:hover {
        background-color: #c1d1ff ; /* Darker blue on hover for pH */
    }
    ...
    background-size: 30px 30px; /* Adjust size based on button dimensions */
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.9); /* Initial shadow for raised effect */
    background-repeat: no-repeat;
    background-position: center;
    margin-bottom: 15px;
    transition: all 0.2s ease; /* Smooth transition for push effect */
}

#activateButton3:active {
    box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.5); /* Shadow gets closer to the button */
    transform: translateY(2px); /* Slightly moves button down */
}
